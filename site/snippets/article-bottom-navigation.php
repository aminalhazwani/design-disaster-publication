<nav class="article__nav--bottom" role="navigation">
	<?php if($next = $page->nextVisible()): ?>
    	<a class="article__nav--bottom--next" href="<?php echo $next->url() ?>" style="background-image:url(<?php foreach($next->images() as $image): ?><?php if($image->cover() != ''): ?><?php echo $image->url() ?><?php endif ?><?php endforeach?>)">
    ...
    <?php if($prev = $page->prevVisible()): ?>
    	<a class="article__nav--bottom--prev hyphenate" href="<?php echo $prev->url() ?>" style="background-image:url(<?php foreach($prev->images() as $image): ?><?php if($image->cover() != ''): ?><?php echo $image->url() ?><?php endif ?><?php endforeach?>)">
    		<div class="article__nav--bottom--overlay"></div>
